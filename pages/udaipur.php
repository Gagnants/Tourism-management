...
<body style="background:url(../images/f1.png) repeat;">
<bgimage="abc.jpg">
<header>
 ...
 <h1 align="center" style="text-shadow:#0F6 2px 2px ; font-family:'Lucclassa Console', Monaco, monospace; font-size:64px; color:#0CC;"><B> Welcome to Udaipur</B></h1><br>
<h3 align="center" style="color:#C9F; font-family:'Comic Sans MS', cursive">Eternal Udaipur: World's Favorite Lakeside Heritage City</h3>
